...
function clearAllDots(){
  ...
  // var dosArr = document.getElementsByClassName("leaflet-marker-icon"); 
...
function fetchTweetsInES( keyWord ) {
  ...
  // Send a POST request
  axios.get('/search?search_str='+keyWord)
  .then(function(response){
    ...
    // response.data.map(function(dataObj){
    //   var circle = L.marker([dataObj['_source']['tweet_geo_coord'][0],dataObj['_source']['tweet_geo_coord'][1]]).addTo(map);
